...
- [Novos Imóveis](./docs/contexts/new-properties/CONTEXT.md) — classifies recently observed listings and price-based opportunities from Published Snapshots.
...
- **Novos Imóveis -> Crawler Machine**: Novos Imóveis compares stable Listing Identities across a Crawl Agency's Published Snapshots and evaluates current published listings against comparable market inventory.
