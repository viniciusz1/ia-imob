...
class ExtractionPolicyVersion extends Model
{
    protected $table = 'crawler.extraction_policy_versions';
    ...
    protected static function booted(): void
    {
        static::updating(function (self $version): void {
            ...
            if ($contentChanges !== []) {
                throw new LogicException('Available or archived Extraction Policy versions are immutable.');
            }
        });
    }
